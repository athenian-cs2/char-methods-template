...
public class MyTests {
  ...
  public void testRemoveNumbers() {
    assertEquals(
        "hello world!",
        MyMain.removeNumbers("h1e2l3l4o5 6w7o8r9l0d00!"),
        "Calling removeNumbers on the string \"h1e2l3l4o5 6w7o8r9l0d00!\" should output: hello"
            + " world!");
    assertEquals(
        "the athenian school",
        MyMain.removeNumbers("151111the athenian school22224"),
        "Calling removeNumbers on the string \"151111the athenian school22224\" should output: the"
            + " athenian school");
    assertEquals(
        "apple orange banana",
        MyMain.removeNumbers("1a2p3p4l5e 6o7r8a9n0g1e 2b3a4n555ana688"),
        "Calling removeNumbers on the string \"1a2p3p4l5e 6o7r8a9n0g1e 2b3a4n555ana688\" should"
            + " output: apple orange banana");
    assertEquals(
        "cranberry dragonfruit fig",
        MyMain.removeNumbers("72cran23be2r1ry dr453agon12fr3uit 33fi2g72"),
        "Calling removeNumbers on the string \"72cran23be2r1ry dr453agon12fr3uit 33fi2g72\" should"
            + " output: cranberry dragonfruit fig");
  }
}
